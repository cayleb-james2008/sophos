...
export function MessageRow({
  ...
  /** Fork a new session from an assistant message. */
  onFork?: (message: TranscriptMessage) => void;
}) {
  ...
  return (
    <div className="msg-row">
      ...
      <div className="msg-body">
        ...
        {/* Copy + retry + fork on hover for assistant content */}
        {message.content && !isStreaming ? (
          <div className="msg-actions-wrap">
            <MessageActions
              ...
              canFork={!isStreaming && message.role === "assistant"}
            />
          </div>
        ) : null}
      </div>
