...
export type IpcCommand =
  ...
  | { method: "setModel"; params: { provider: string; model: string; thinking?: string; serviceTier?: string; transport?: string; contextWindow?: number; maxOutputTokens?: number; fastMode?: boolean } }
...
export interface ModelInfo {
  ...
  /** Whether the model supports a fast/low-latency mode toggle. */
...
export interface Settings {
  ...
  /** Default fast-mode toggle for models that support it (mirrors defaultThinking). */
  defaultFastMode?: boolean;
  /** Current fast-mode state, persisted so it survives reconnects. */
  fastMode?: boolean;
