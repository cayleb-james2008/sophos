...
| **#735 / #668 / #869** Multiple console windows steal focus on launch and on every tool call. | Tauri spawns the daemon and bridge with `CREATE_NO_WINDOW`; all child processes inherit hidden consoles. No focus-stealing windows. |
